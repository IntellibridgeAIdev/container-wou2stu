...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wou2stu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wou2stu.containers.anotherwebservice.com/
...
```
git clone git@github.com:IntellibridgeAIdev/container-wou2stu.git
cd container-wou2stu
```
...
```
docker attach container-wou2stu
```
